              ...
              return (
                ...
                >
                  ...
                  <div className="flex w-full flex-wrap items-center gap-2 sm:w-auto">
                    <Link
                      href={`/workout/${w.id}`}
                      className="inline-flex flex-1 cursor-pointer items-center justify-center gap-2 rounded-full border border-neutral-700 bg-transparent px-4 py-2 text-xs font-semibold tracking-wide text-neutral-300 transition hover:border-neutral-500 hover:text-white sm:flex-none"
                    >
                      View Details
                    </Link>
                    ...
                    {tab === "plan" && (
                      <button
                        ...
                        className="inline-flex flex-1 cursor-pointer items-center justify-center gap-2 rounded-full bg-brand px-4 py-2 text-xs font-semibold tracking-wide text-black transition hover:brightness-110 sm:flex-none"
                      >
